...
public class SynergyManager : MonoBehaviour
{
    ...
    {
        synergie1.name = "신성";
        //synergie1.icon = Resources.Load<Sprite>(""); //리소스 이름를 ""사이에 넣으면 아이콘 정보 저장 
    ...
    {
        synergie2.name = "암영";
        //synergie2.icon = Resources.Load<Sprite>(""); //리소스 이름를 ""사이에 넣으면 아이콘 정보 저장 
    ...
    {
        synergie3.name = "기원";
        //synergie3.icon = Resources.Load<Sprite>(""); //리소스 이름를 ""사이에 넣으면 아이콘 정보 저장 
    ...
    {
        synergie4.name = "황혼";
        //synergie4.icon = Resources.Load<Sprite>(""); //리소스 이름를 ""사이에 넣으면 아이콘 정보 저장 
    ...
    {
        synergie5.name = "근원";
        //synergie5.icon = Resources.Load<Sprite>(""); //리소스 이름를 ""사이에 넣으면 아이콘 정보 저장 
    ...
    {
        synergie6.name = "천공";
        //synergie6.icon = Resources.Load<Sprite>(""); //리소스 이름를 ""사이에 넣으면 아이콘 정보 저장 
